                                ...
                                >
                                    <Popup>
                                        <div>
                                            ...
                                            <div>{station.brand} - {station.distance && <>{station.distance.toFixed(2)} Km</>}</div>
                                            {station.fuels && station.fuels.map((fuel, index) =>
                                                <div key={index} style={{paddingTop: '4px', paddingBottom: '4px'}}>
                                                    <h4 style={{margin: 0}}>{fuel.name}</h4>
                                                    <p style={{margin: 0}}>Servito {fuel.prices.served}€ -
                                                        Self {fuel.prices.self}€</p>
                                                </div>
                                            )}
                                        </div>
                                    </Popup>
